...
\usepackage{ucs}
\usepackage[utf8x]{inputenc}  % CJK characters
...
\lstset{
    ...
    literate=%
        ...
        {^^c3^^be}{{\th}}1  % thorn
        {^^c3^^bf}{{\"{y}}}1  % y umlaut
        {^^e3^^81^^a6}{{te}}2  % hiragana "te"
        {^^e3^^82^^8b}{{ru}}2  % hiragana "ru"
        {^^e3^^80^^82}{{.}}1  % hiragana ".", period
        {^^e6^^84^^9b}{{Love}}4  % kanji for Love
        {^^e3^^81^^97}{{shi}}3  % hiragana "shi"
        {^^e6^^97^^a5}{{\unichar{65e5}}}1  % kanji for Sun
        {^^e6^^9c^^ac}{{Root}}4  % kanji for Root
}
