...
\usepackage{xeCJK}  % CJK characters
\setCJKmainfont{IPAMincho}  % supports Japanese (at least)
...
\lstset{
    ...
    literate=%
        ...
        {^^e3^^81^^97}{{\char"3057}}1  % hiragana "shi"
        {^^e6^^97^^a5}{{\symbol{"25A1}}}1  % kanji for Sun
