...
%       {^^e6^^97^^a5^^e6^^9c^^ac}{Japan}}6
        {^^c2^^a9}{{\copyright}}2
        {^^c2^^bf}{{?'}}2  % upside down question mark
        {^^c3^^9f}{{\ss}}2  % eszett, 0xdf
        {^^c3^^a4}{{\"a}}2  % a-umlaut, 0xe4
        {^^c3^^ab}{{\"e}}2  % e-umlaut, 0xeb
        {^^c3^^b6}{{\"o}}2  % o-umlaut, 0xf6
        {^^c3^^b8}{{\o}}2  % norwegian o-slash, 0xf8
