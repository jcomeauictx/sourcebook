...
\lstinputlisting[caption=ltmain.sh]{/usr/src/jcomeauictx/casperscript/tiff/config/ltmain.sh}
\lstinputlisting[caption=ft-hb.c]{/usr/src/jcomeauictx/casperscript/freetype/src/autofit/ft-hb.c}
\end{document}
